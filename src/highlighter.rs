...
impl Default for Highlighter {
    fn default() -> Self {
        ...
        syntax_set_builder.add_from_folder("./assets/syntax", true).unwrap();
        let mut themes = syntect::highlighting::ThemeSet::new();
        themes.add_from_folder("./assets/themes").unwrap();
        Self {
            ps: syntax_set_builder.build(),
            themes,
        }
    }
}
...
impl Highlighter {
    ...
    fn highlight_impl(&self, theme: &CodeTheme, text: &str, language: &str) -> Option<LayoutJob> {
        ...
        let mut h = HighlightLines::new(syntax, &self.themes.themes["note.dark"]);
            ...
            for (style, range) in h.highlight_line(line, &self.ps).ok()? {
                ...
                job.sections.push(LayoutSection {
                    ...
                    format: TextFormat {
                        ...
                        color: text_color,
                        background: egui::Color32::from_rgba_unmultiplied(bg.r, bg.g, bg.b, bg.a),
                        italics,
                        underline,
                        ..Default::default()
                    },
